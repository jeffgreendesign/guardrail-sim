...
**guardrail-sim** simulates business rules and policies before they hit production. Define discount caps, shipping constraints, and promotional logic—then test every edge case.
