...
The **Universal Commerce Protocol** is an open standard for agentic commerce, launched by Shopify and Google in late 2025 and now actively adopted by 20+ global commerce partners. It defines how AI agents interact with e-commerce platforms in a standardized, secure way.
